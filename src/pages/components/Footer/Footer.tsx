...
export function Footer() {
    return (
        <>
            <div className="border-t border-gray-200 bg-white px-4 sm:px-8 md:px-16 lg:px-24 xl:px-44">
                <div className="container mx-auto py-8 sm:py-10">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="col-span-1">
                            <h3 className="text-xl font-semibold text-gray-800 mb-4">Empresa</h3>
                        ...
                        <div className="col-span-1 lg:text-right">
                            ...
                            <div className="flex lg:justify-end">
                                <button
                                    type="button"
                                    className="w-full lg:w-auto px-6 py-2 bg-blue-500 text-white font-medium text-sm rounded-md hover:bg-blue-600 transition-colors duration-300"
                                >
                                    Entrar em contato
                                </button>
                            </div>
